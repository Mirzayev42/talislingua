...
Java 17 & Spring Boot 3 - Əsas backend karkası.

Spring Data JPA & Hibernate - Verilənlər bazası ilə əlaqə.

PostgreSQL (Supabase) - Bulud əsaslı relyasiyalı baza.

Docker - Konteynerləşdirmə və asan deployment.

Lombok & MapStruct - Təmiz kod və DTO mapping üçün.

Thymeleaf - Sadə UI idarəetmə paneli üçün.
